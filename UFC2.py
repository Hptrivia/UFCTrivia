...
with gr.Blocks() as demo:
    ...
    with gr.Column(visible=False) as support_page:
        gr.Markdown(
            "## 🙏 Support This App\n\n"
            "If you enjoy the trivia and **want more series/shows**, please consider supporting me!\n\n  "
            "Your support helps me add new shows, write more questions, add new features and keep the server running.\n\n"
            "☕ Buy me a coffee on [Ko-fi](https://ko-fi.com/triviaking)"
        )
